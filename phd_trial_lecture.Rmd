...
- Intuitive for multi-cellular systems modeling
...
`r shiny::icon("long-arrow-alt-right")` Parameter optimization in 2D simulations correlated with patient response to immunotherapy .smalli.purple[Ozik (2019). Learning-accelerated discovery of immune-tumour interactions]
]
.pull-right-33[
