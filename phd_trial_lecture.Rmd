...
.little[
- Fuzzy logic modeling .small.purple[Morris (2016)]
...
Simple math model from [Roux 2015] to explain cell‐to‐cell variability by the overcoming of a caspase activity threshold

???

- .green[Even without topological knowledge, fancy equations, or sophisticated deep neural network architectures, models can be very useful] .purple.small[Fitzgerald (2006)]
...
- Morris et al. (2010). Logic-based models for the analysis of cell signaling networks.
- ElKalaawy et al. (2015). Methodologies for the modeling and simulation of biochemical networks, illustrated for signal transduction pathways: A primer.
- Le Novere, N. (2015). Quantitative and logic modelling of molecular and gene networks. Nature Reviews Genetics, 16(3), 146–158. https://doi.org/10.1038/nrg3885
- Metzcar et al. (2019). A Review of Cell-Based Computational Modeling in Cancer Biology. Https://Doi.Org/10.1200/CCI.18.00069, (3), 1–13. https://doi.org/10.1200/CCI.18.00069
...
- Letort (2018)
- COPASI (Hoops (2006): ODEs and stochastic simulations or hybrids of these
- Chaste: Cancer, Heart and Soft Tissue Environment Cooper (2020)
- Virtual Cell Blinov (2017)
