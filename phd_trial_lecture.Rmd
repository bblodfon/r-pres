...
.red[2nd cause of death] worldwide .small.purple[Ritchie & Roser (2018)]

## Why is cancer challenging?

![:scale 85%](img/trial-lecture/cancer_challenges.svg)
...
# Recap: Non-spatial modeling frameworks
...
- .green[High explanatory capacity/closer to reality]
...
## Mixed Discrete-Continuous (hybrid) modeling
...
- Capture signal strength and time dynamics
...
ML methods .red[cannot predict latent variables]!
...
## .little[Agent-based modeling: tumor growth]
...
Choose appropriate modeling framework based on;

- Size of the model
- The type of information (data) available
- The granularity of answers sought from the simulations
- Knowledge of pros and cons of each framework
- Area of application
