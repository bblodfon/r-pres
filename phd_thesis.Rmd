...
- Data formats
- Causal interactions are the **building blocks** for the Prior Knowledge Networks that are used to construct logical models, which we are going to discuss later!
