...
<ul>
  ...
  <li>VSM: .purple[Visual Syntax Method]</li></br>
  <li>Example app: .green[causalBuilder]</li></br>
</ul>
]
...
![:scale 83%](img/vsm/how_biology_systems_work.png)

.large[It takes .purple.large[**TIME**] for a human to *understand* and *process* text]

---

# Discovery effort disanalogous with result accessibility (free-text)
...
.large.center[Natural Language .green[piece of information] => biocuration => .green[Computable Information]]
...
.pull-left-large[![:scale 80%](img/vsm/patient.png)]

.pull-right-large[
<ul>
    <li>We miss pieces from the puzzle!</li></br>
    <li>We do not .bold[fully benefit] from the decades of expensive research results that exist out there!</li></br>
    <li>.bold[Modeling and understanding] all the complexity becomes infeasible</li></br>
    <li>Temporary solutions are favored (e.g. cancer drugs)</li>
</ul>
]
...
<ul>
  <li>Trains: structured data whooshes from mind to mind on rails!</li></br>
  <li>Horses are .bold[too slow] but .bold[really popular]!</li></br>
  <li>Complex vs one-type cargo</li>
</ul>
...
.center.large[.purple.large[**TESLA**] => Easy-to-use tool thats creates digital summaries of **PDFs**!]

--

.large[(...and remember: **"Hold your horses!!!"**)]
...
... a tool with which the computer can do something meaningful - apply .purple.large[**REASONING**] and solve the cancer problem
...
# VSM: .purple[Visual Syntax Method]

---

# Visual Syntax Method: *VSM-terms*

![](img/vsm/vsm_summary1.png)

---

# Visual Syntax Method: *VSM-connectors*

![](img/vsm/vsm_summary2.png)

---

# Visual Syntax Method: Summary 3 + Example

Example: John eats chicken with fork example?

![](img/vsm/vsm_summary3.png)

---

# VSM app: *causalBuilder*
...
# Example annotation with *causalBuilder*
...
Special thanks to: **Vasundra Touré** (MI2CAST, causalBuilder), **Steven Vercruysse** (VSM creator) and **Martin Kuiper** (Supervision)]
