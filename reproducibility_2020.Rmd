...
![:scale 95%](img/reproducibility/reproducibility_spectrum.png)
...
---
# Example 2: Docker Containers ![:scale 10%, 10%](img/reproducibility/docker.png)
...
![:scale 80%](img/reproducibility/pysb-macros.png)
...
.pull-left[![](img/reproducibility/pysb-reuse1.png)]
.pull-right[![:scale 80%](img/reproducibility/pysb-reuse2.png)]
